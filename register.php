...
<table width="100%" border="0" cellspacing="0" cellpadding="5" class="main">
  ...
  <tr> 
	...
	<?php 
	 if (isset($_GET['done'])) { ?>
	  <h2>谢谢</h2> 您的注册已经成功，可以点击以下链接登录<a href="login.php">登录</a>";
	 <?php exit();
	  }
	?></p>
      <h3 class="titlehdr">用户注册</h3>
      <p>请正确的填入用户信息 所有都需要填</p>
	 <?php	
	 if(!empty($err))  {
	   echo "<div class=\"msg\">";
	  foreach ($err as $e) {
	 ...
	 ?> 
      ...
      <form action="register.php" method="post" name="regForm" id="regForm" >
        <table width="95%" border="0" cellpadding="3" cellspacing="3" class="forms">
          <tr> 
            <td>用户名<span class="required"><font color="#CC0000">*</font></span></td>
          ...
          <tr> 
            ...
            <td><input name="pwd" type="password" class="required password" minlength="5" id="pwd"> 
              <span class="example">** 最少5个字符..</span></td>
          </tr>
          <tr> 
